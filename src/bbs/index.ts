...
export type CreateGeneratorsDsts = {
...
export type CipherSuite = {
	...
	calculate_random_scalars(count: number): Promise<bigint[]>,
	real_calculate_random_scalars(count: number): Promise<bigint[]>,
	octets_to_point_E1(ostr: BufferSource): PointG1,
	octets_to_point_E2(ostr: BufferSource): PointG2,
	calculate_domain(
		PK: BufferSource,
		Q_1: PointG1,
		H_Points: PointG1[],
	...
	signature_to_octets(A: PointG1, e: bigint): BufferSource,
	octets_to_signature(signature_octets: BufferSource): [PointG1, bigint],
	octets_to_pubkey(PK: BufferSource): PointG2,
	octets_to_proof(proof_octets: BufferSource): [PointG1, PointG1, PointG1, bigint, bigint, bigint, bigint[], bigint],
